...
class AnalysesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analysis" do
    assert_difference('Analysis.count') do
      post analyses_url, params: { analysis: { num1: @analysis.num1, num2: @analysis.num2, user_id: @analysis.user_id } }
    end
  ...
  test "should update analysis" do
    patch analysis_url(@analysis), params: { analysis: { num1: @analysis.num1, num2: @analysis.num2, user_id: @analysis.user_id } }
